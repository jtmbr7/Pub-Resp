...
% After the algorithm finishes, write the best path to BestResultFound.m
fileID = fopen('BestResultFound.m', 'w');  % Open the file in write mode

% Write the best path in the required format
